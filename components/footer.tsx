...
export function Footer({ className }: FooterProps) {
  const navigation = {
    ...
    talent: [
      { name: "タレント登録", href: "/signup" },
      { name: "タレント向けガイド", href: "/guide/talent" },
      { name: "収益について", href: "/guide/revenue" },
    ],
    company: [
  ...
  const social = [
    ...
    {
      name: "Instagram",
      href: "https://instagram.com/fanc_official",
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "YouTube",
      href: "https://youtube.com/@fanc_official",
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
